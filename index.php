...
$path = trim(str_replace('gymManagementSystem/', '', $request_uri[0]), '/');  //first element, which is the path of the uri
...
switch ($path) {
    ...
    case 'memberships':
        include_once __DIR__ . '/src/controllers/membership.controller.php';
        break;

    case 'trainers':
        include_once __DIR__ . '/src/controllers/trainer.controller.php';
        break;

    case 'classes':
        include_once __DIR__ . '/src/controllers/class.controller.php';
        break;

    case 'bookings':
        include_once __DIR__ . '/src/controllers/booking.controller.php';
        break;

    case 'payments':
        include_once __DIR__ . '/src/controllers/payment.controller.php';
        break;

    case 'attendence':
        include_once __DIR__ . '/src/controllers/attendence.controller.php';
        break;
